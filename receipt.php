...
<div class="a">
	...
	<body bgcolor="white">
		<h2 Align="left" font face="Courier New" , Courier, monospace" Color="Green">&nbsp;&nbsp;VFLIX Movie Ticket Reservation</br></br>&nbsp;&nbsp;&nbsp;Customer'S COPY</font>
		</h2>
		<h1 align="center">
			<font face="Franklin Gothic Medium" Color="black" size="3">
				<table border=1 align=center>
					...
					$query = mysqli_query($conn, "SELECT * FROM `movies` ORDER BY `movies`.`ID`  DESC"); {
		...
		<h1 align="left">
			<font face="arial" Color="black" size="2px">&nbsp;&nbsp;This is your copy. Keep this part in a sale place. The following are requirements when claiming your ticket:&nbsp;&nbsp;</br></font>
			<font size="1">&nbsp;&nbsp;*&nbsp;This Ticket Voucher (Customer's copy)<br>&nbsp;&nbsp;*&nbsp;Personally claim your movie ticket after reservation on working days in any VFLIX ticket booth nationwide. Working days are from Monday to Sunday.<br>&nbsp;&nbsp;This document is valid after reservation until <?php echo date("M-d-Y"); ?>&nbsp;between&nbsp;<?php
																																																																																											include('conn.php');
																																																																																											$query = mysqli_query($conn, "SELECT * FROM `movies` ORDER BY `movies`.`Ticket_Number`  DESC"); {
																																																																																												$row = mysqli_fetch_array($query);
																																																																																												echo "" . $row['Time'] . "";
																																																																																											}
																																																																																											?> </font>
		...
		<br>
		<h3 align="left" font face="Courier New, Courier, monospace">&nbsp;&nbsp;Customer's Signature:&nbsp;&nbsp;______________________
		</h3>
</div>
<h3 align="center">
	...
	<div class="r">
		<button style="background: green;width: 100px; height :30px ;border-radius: 15px;color:white; float:left ;margin-left: 170px;" onclick="myfunction()">RETURN</button>
	</div>
	<script>
function myfunction(){
